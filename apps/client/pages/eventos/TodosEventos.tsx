...
// Mock Data matching the user's image request
const MOCK_PUBLIC_EVENTS: PublicEventData[] = [
  ...
  { id: 11, title: 'Workshop de React', category: 'Educação', date: '10 jan. 2026', time: '09:00', imagePlaceholder: true },
  { id: 12, title: 'Lançamento App', category: 'Tecnologia', date: '15 fev. 2026', time: '19:30', imagePlaceholder: true },
];

export const TodosEventos: React.FC = () => {
  ...
  const filteredData = useMemo(() => {
    return MOCK_PUBLIC_EVENTS.filter(item => {
      const matchesSearch = item.title.toLowerCase().includes(searchTerm.toLowerCase());
      // Mock state/city logic would go here if data had it
